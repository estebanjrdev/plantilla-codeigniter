<body class="light_theme  fixed_header left_nav_fixed">
    ...
    <div class="inner">
      ...
      <div class="left_nav">
        ...
        <div class="left_nav_slidebar">
          <ul>
            <li> <a href="<?php echo site_url(); ?>/auth"> <i class="fa fa-home"></i> Inicio <span class="plus"><i class="fa fa-check"></i></span> </a> </li>
            <li><a href="<?php echo site_url(); ?>/auth/usuarios"><i class="fa fa-users"></i> Usuarios <span class="plus"><i class="fa fa-check"></i></span> </a></li>
            <li><a href="<?php echo site_url(); ?>/auth/trazas"><i class="fa fa-tasks"></i> Trazas <span class="plus"><i class="fa fa-check"></i></span> </a></li>
          </ul>
        </div>
      </div>
      <!--\\\\\\\left_nav end \\\\\\-->
  ...
  <?php include('perfil_usuarios.php'); ?>